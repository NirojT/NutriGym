...
const SubscriptionForm = ({
  ...
  return (
    <div>
      <div className="flex justify-center font-extrabold text-xl mb-6">
        Subscription Plans
      </div>
      ...
      <div className="grid grid-cols-2 gap-4 items-center space-y-4">
        ...
        <div className="flex flex-col">
          <label className="font-semibold mb-2">Select Plan:</label>
          <select
            value={plan}
        ...
        <div className=" flex  gap-2">
          <label className="font-semibold mb-2"> Full Paid:</label>
          <input
            type="checkbox"
            onChange={(e) => {
        ...
        <div className=" flex  gap-2">
          <label className="font-semibold mb-2"> Due:</label>
          <input
            type="checkbox"
            onChange={(e) => {
