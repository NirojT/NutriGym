...
const Form = () => {
  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center justify-center py-[3em] px-[1rem] rounded w-[80%] bg-slate-50 shadow-md max-w-[25em] ">
          ...
          <div className="mt-[1.5em]">
            <form className="flex flex-col gap-y-4">
              ...
              <button
                ...
                className="mt-2 rounded btn bg-blue-600 hover:bg-blue-500 text-[#efefef]"
              >
